...
export default async function ShareFoldersPage() {
    ...
    if (!session) redirect(`/api/auth/signin?callbackUrl=/account/folders/share`);
    ...
    const styles = {
        ...
        shell: { maxWidth: 1100, margin: "48px auto", padding: 16, position: "relative" },
        h1: {
            margin: 0,
        ...
        <main style={styles.page}>
            ...
            <div style={styles.shell}>
                <section style={styles.card}>
                    <h1 style={styles.h1}>Share folders</h1>
                    <p style={styles.sub}>Manage read-only links and team members (Owner / Editor / Viewer).</p>
                    <ShareClient />
                </section>
            </div>
        </main>
