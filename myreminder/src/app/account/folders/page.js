...
export default async function FoldersPage() {
    ...
    if (!session) {
        redirect(`/api/auth/signin?callbackUrl=/account/folders`);
    }
        ...
        <main style={styles.page}>
            ...
            <div style={styles.shell}>
                <section style={styles.head}>
                    <h1 style={styles.h1}>Folders</h1>
                    <p style={styles.sub}>
                        Organize your countdowns into nested folders and set aliases per folder.
                    </p>
                </section>
