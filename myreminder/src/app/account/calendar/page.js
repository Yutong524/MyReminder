...
export default async function CalendarPage() {
    ...
    if (!session) redirect(`/api/auth/signin?callbackUrl=/account/calendar`);
        ...
        <main style={styles.page}>
            ...
            <div style={styles.shell}>
                <section style={styles.card}>
                    <h1 style={styles.h1}>Calendar sync</h1>
                    <p style={styles.sub}>Generate a private ICS link to subscribe in Google, Apple, or Outlook Calendar.</p>
                    <CalendarClient />
                </section>
            </div>
        </main>
